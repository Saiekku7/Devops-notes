...
#Creating an IAM policy for your service account that will allow your CA pod to interact with the autoscaling groups either by CLI/ Console iam ->policy 
aws iam create-policy --policy-name k8s-asg-policy --policy-document file://k8s-asg-policy.json  

GO to nodegroup role-> attach the above policy 
      ...
      containers:
        - image: k8s.gcr.io/autoscaling/cluster-autoscaler:v1.21.0
          ...
          command:
            ...
            - --node-group-auto-discovery=asg:tag=k8s.io/cluster-autoscaler/enabled,k8s.io/cluster-autoscaler/demo-eks # change clustername
